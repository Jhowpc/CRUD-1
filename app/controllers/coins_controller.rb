class CoinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coin.save
        format.html { redirect_to coin_url(@coin), notice: "#{t('notice.coin_created')}" }
  ...
  def update
    respond_to do |format|
      if @coin.update(coin_params)
        format.html { redirect_to coin_url(@coin), notice: "#{t('notice.coin_updated')}" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to coins_url, notice: "#{t('notice.coin_deleted')}" }
